    ...
    <div className="footerContainer">
      <div className="topFooter">
        <div className="supportsContainer">
          <div className="supports">
            ...
            <span className="nikeFooterGanganTsagaan">NIKE JOURNAL</span>
          ...
          <div className="supports">
            <span className="nikeFooterGanganTsagaan">ABOUT NIKE</span>
      ...
      <div className="botFooter">
        ...
        <div className="botSideTwo">
          ...
          <span className="nikeFooterDajguWhite">Nike Privacy Policy</span>
